...
for file_ID = 1:18
    ...
    voxel = [15.5,15.5,70];
    load([data_path 'Vwater_ss_' sprintf('%03d',file_ID) '.mat']); %Load statsVwater_ss with B_ID.
    ...
    %load([out_path 'CTB_Pos_100\' sprintf('%03d',file_ID) '.mat']); %Centroid_simp_rand,Centroid_complex_rand
    %temp = Centroid_complex_rand;
    load([out_path 'CTB_Neg\' sprintf('%03d',file_ID) '.mat']); %Centroid_simp_rand,Centroid_complex_rand
    %Centroid_complex_rand = temp;
