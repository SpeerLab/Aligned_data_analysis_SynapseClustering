...
clear all;clc
%
data_path = 'X:\Chenghang\4_Color_Continue\Small_Scale_CTB\';
...
for file_ID = 16:18
    ...
    Weighted_centroid_1_new = zeros(numel(statsRwater_sssss),3);
    Weighted_centroid_2_new = zeros(numel(statsRwater_ssssn),3);
    ...
    for i = 1:numel(statsRwater_sssss)
        Weighted_centroid_1(i,:) = statsRwater_sssss(i).WeightedCentroid;
    end
    for i = 1:numel(statsRwater_ssssn)
        Weighted_centroid_2(i,:) = statsRwater_ssssn(i).WeightedCentroid;
    end
    ...
    save([data_path sprintf('%03d',file_ID) '.mat'],'Weighted_centroid_1_new','Weighted_centroid_2_new');
end
%%
closest_dist(:,1)
closest_dist(:,2)
