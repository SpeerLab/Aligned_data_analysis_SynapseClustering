...
out_path = 'X:\Chenghang\4_Color\Complex_Syn_4_shell\Fig. 1\';
...
% Pos_Comp
    ...
    BID_simp = BID_simp(~ismember(BID_simp,BID_comp));
    BID_comp = BID_comp>0;
    statsRwater_sssss = statsRwater_sssss(BID_comp);
    clear BP BG bg2
    ...
    BID_simp = BID_simp(~ismember(BID_simp,BID_comp));
    BID_comp = BID_comp>0;
    statsRwater_ssssn = statsRwater_ssssn(BID_comp);
    clear BP BG bg2
    disp('allocating arrays')
    BP = zeros(info.Height, info.Width, num_images,'uint8');
    BP2 = zeros(info.Height, info.Width, num_images,'uint8');
