...
outpath = 'X:\Chenghang\4_Color\Complex_Syn\';
...
for file_ID = 1:18
    ...
    dist_list_12 = tril(dist_list_12);
    ...
    dist_list_12_new = tril(dist_list_12_new);
    ...
    saveas(gcf,[outpath sprintf('%03d',file_ID) '_11.png']);
    saveas(gcf,[outpath sprintf('%03d',file_ID) '_11.fig']);
    close;
    ...
    saveas(gcf,[outpath sprintf('%03d',file_ID) '_22.png']);
    saveas(gcf,[outpath sprintf('%03d',file_ID) '_22.fig']);
    close;
    ...
    saveas(gcf,[outpath sprintf('%03d',file_ID) '_12.png']);
    saveas(gcf,[outpath sprintf('%03d',file_ID) '_12.fig']);
    close;
