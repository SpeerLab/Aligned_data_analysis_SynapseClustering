...
clear;clc
%
data_path = 'X:\Chenghang\4_Color\Complex_Syn_2\Dist_matrix_comp_comp\';
data_simp_path = 'X:\Chenghang\4_Color\Complex_Syn_2\Dist_comp_simp_neg\';
...
for file_ID = 1:18
    ...
    load([data_path sprintf('%03d',file_ID) '.mat']); %dist_list_12_sorted_new and dist_list_12_sorted
