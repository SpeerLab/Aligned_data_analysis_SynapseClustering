...
for file_ID = 1:18
    disp(file_ID);
    load([data_path sprintf('%03d',file_ID) '.mat'],'dist_list_11_sorted','dist_list_12_sorted','dist_list_22_sorted');
    load([data_path sprintf('%03d',file_ID) '_new.mat'],'dist_list_11_sorted_new','dist_list_12_sorted_new','dist_list_22_sorted_new');
...
close;
%%
writematrix(dist_list_12_all_norm,[data_path '12.csv'],'WriteMode','append');